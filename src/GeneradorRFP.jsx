...
export default function GeneradorRFP() {
  ...
  return (
    // CONTENEDOR PRINCIPAL: Candado de diseño para evitar que se aplaste
    <div style={{ display: 'flex', width: '100%', height: 'calc(100vh - 100px)', gap: '20px', padding: '15px', boxSizing: 'border-box', backgroundColor: '#f4f4f4', overflow: 'hidden' }}>
      ...
      {/* PANEL IZQUIERDO: FORMULARIO Y CONTROLES (Protegido con flexShrink: 0) */}
      <div style={{ width: '450px', flexShrink: 0, backgroundColor: 'white', padding: '25px', borderRadius: '8px', overflowY: 'auto', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ marginBottom: '25px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginBottom: '15px' }}>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              {reqVigenciaFiel === 'Si' && <input placeholder="Ingrese vigencia (Ej: 60 días...)" value={valVigenciaFiel} onChange={e => setValVigenciaFiel(e.target.value)} style={{ width: '100%', padding: '6px', marginTop: '5px' }} />}
            </div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: '25px', backgroundColor: '#eef2f7', padding: '15px', borderRadius: '6px', border: '1px solid #cce5ff' }}>
          ...
          <textarea rows="3" placeholder="Ej: Servicio de instalación de cámaras CCTV en 5 tiendas..." value={contextoIA} onChange={e => setContextoIA(e.target.value)} style={{ width: '100%', padding: '8px', border: '1px solid #ccc', borderRadius: '4px', resize: 'vertical' }}></textarea>
          ...
          <div style={{ marginTop: '10px', padding: '12px', backgroundColor: 'white', borderRadius: '4px', border: '1px dashed #004A99' }}>
            <label style={{ fontSize: '12px', fontWeight: 'bold', color: '#333', display: 'flex', alignItems: 'center', cursor: 'pointer', margin: 0 }}>
              <span style={{ backgroundColor: '#17a2b8', color: 'white', padding: '6px 10px', borderRadius: '4px', marginRight: '10px', transition: '0.2s' }}>📎 Adjuntar Archivo</span>
          ...
          <button onClick={procesarConIA} disabled={cargandoIA} style={{ width: '100%', padding: '12px', marginTop: '15px', backgroundColor: cargandoIA ? '#ccc' : '#6f42c1', color: 'white', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: cargandoIA ? 'not-allowed' : 'pointer', transition: '0.3s' }}>
            {cargandoIA ? '⏳ Analizando documentos...' : '✨ Generar Alcance con Gemini IA'}
          </button>
        </div>
      ...
      {/* PANEL DERECHO: VISUALIZADOR Y DESCARGAS (Ocupa el resto del espacio) */}
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '15px', minWidth: 0 }}>
        ...
        {/* HOJA DEL DOCUMENTO (TEXTO ÍNTEGRO) */}
        <div style={{ flex: 1, backgroundColor: '#e5e5e5', padding: '20px', borderRadius: '8px', overflowY: 'auto', display: 'flex', justifyContent: 'center' }}>
          <div id="documento-rfp" style={{ backgroundColor: 'white', width: '21cm', minHeight: '29.7cm', padding: '2.5cm', boxShadow: '0 4px 10px rgba(0,0,0,0.15)', fontFamily: 'Arial, sans-serif', fontSize: '10pt', color: '#333', lineHeight: '1.5' }}>
            ...
            <p style={{ textAlign: 'justify', fontStyle: 'italic' }}>Este documento es propiedad del Titular del Proceso. En contenido de este documento está sujeto a reserva. Este documento no puede ser reproducido, ni en su totalidad ni parcialmente, ni mostrado a terceros que no tengan relación con el Proceso de Solicitud de Propuestas, ni utilizado con propósitos comerciales sin previa autorización escrita del Titular del Proceso.</p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '30px', fontSize: '9pt' }}>
              <tbody>
                ...
                <tr><td style={{ border: '1px solid #ccc', padding: '5px', fontWeight: 'bold' }}>Tipo de documento a suscribir</td><td style={{ border: '1px solid #ccc', padding: '5px' }} colSpan="2">Acuerdo Comercial Según Aceptación de Bases</td></tr>
            ...
            <div style={{ backgroundColor: '#fffbe6', padding: '10px', border: '1px dashed #ffd700', color: '#856404', fontStyle: 'italic', marginBottom: '20px' }}>
              <strong>[ZONA DE IA: Alcance del Proyecto 3.2 al 3.7]</strong><br/><br/>{alcanceGenerado}
            </div>
