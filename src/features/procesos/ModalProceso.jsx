...
import { clasificacionOpciones, subgerenciasOpciones, tipoCompraOpciones, vigenciaOpciones, mesesRenovacionOpciones } from '../../utils/constantes';

export default function ModalProceso({
  modalProceso, setModalProceso, procesoActual, setProcesoActual, guardarProceso,
  removerProveedorInvitado, proveedoresAprobados, agregarProveedorInvitado,
  removerProveedorAdjudicado, agregarProveedorAdjudicado, handleDetalleAdjudicacionChange
}) {
