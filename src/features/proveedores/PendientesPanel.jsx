...
export default function PendientesPanel({ 
  ...
  // Filtramos localmente solo los pendientes para renderizar la tabla
  const proveedoresPendientes = proveedores.filter(p => p.estado === 'Pendiente');
              ...
              proveedoresPendientes.map(prov => (
                <tr key={prov.id} style={{ borderBottom: '1px solid #eee' }}>
                  ...
                  <td style={{ padding: '8px', verticalAlign: 'middle', wordWrap: 'break-word' }}>
                    ...
                    <a href={`mailto:${prov.email_principal}`} style={{ color: '#004A99', textDecoration: 'none', fontSize: '11px', wordBreak: 'break-all' }}>
