...
export default function AdminGestion({
  proveedoresGestionFiltrados, cargarProveedores, cargarLogsAuditoriaProv, setMostrarModalAuditoria,
  ...
  categoriasDinamicas, abrirEditorProveedor, revocarProveedor, rechazarProveedor
}) {
  return (
    <div>
