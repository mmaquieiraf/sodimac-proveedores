...
export default function ConfiguracionDocs({
  categoriasDinamicas,
  nuevaCatInput, setNuevaCatInput, handleAgregarCategoria, handleEliminarCategoria,
  nuevasSubInputs, setNuevasSubInputs, handleAgregarSubcategoria, handleEliminarSubcategoria
}) {
  return (
    <div>
