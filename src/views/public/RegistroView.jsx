...
import { formatearRUT, validarRUT, sanitizarYCapitalizar } from '../../utils/datosSodimac';
...
export default function RegistroView({
  ...
  const manejarEnvioRegistro = async (e) => {
    ...
    // CORRECCIÓN APLICADA: Llamada segura a la función RPC, eludiendo la restricción RLS
