...
export default function GeneradorFT() {
  ...
  const exportarPDF = async () => {
    ...
    const opciones = {
      ...
      html2canvas: { scale: 3, useCORS: true, scrollY: 0, backgroundColor: '#ffffff', imageTimeout: 0 }, 
        ...
        <div style={{ flex: 1, width: '100%', overflowY: 'auto', display: 'flex', justifyContent: 'center', paddingBottom: '20px' }}>
          <div id="lienzo-ficha-tecnica" style={{ backgroundColor: 'white', width: '210mm', height: '295mm', position: 'relative', fontFamily: 'Arial, sans-serif', color: '#333', overflow: 'hidden', boxShadow: '0 5px 15px rgba(0,0,0,0.3)', boxSizing: 'border-box' }}>
            ...
            <div style={{ position: 'relative', width: '100%', height: '115px', borderBottom: '1px solid #E0E0E0', boxSizing: 'border-box' }}>
              <div style={{ position: 'absolute', left: '40px', top: '38px', width: '160px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                <img src="/logo-sodimac-sin-margen.png" alt="Sodimac" style={{ display: 'block', width: '100%', height: '100%', objectFit: 'contain', objectPosition: 'left center' }} />
              </div>
              <div style={{ position: 'absolute', right: 0, top: 0, backgroundColor: '#005AA9', color: 'white', height: '80px', display: 'flex', alignItems: 'center', padding: '0 40px 0 60px', fontSize: '26px', fontWeight: '900', clipPath: 'polygon(15% 0, 100% 0, 100% 100%, 0% 100%)', letterSpacing: '1px' }}>FICHA TÉCNICA</div>
            </div>
