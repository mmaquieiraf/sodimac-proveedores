...
export default function GeneradorRFQ() {
  // --- FICHA RESUMEN (Simplificada para RFQ) ---
  ...
  // --- TABLA DINÁMICA DE PRODUCTOS (CANTIDAD Y ESPECIFICACIÓN) ---
  ...
  const generarWordFinal = async () => {
    try {
      ...
      doc.setData({
        ...
        productos: productos, // Mapeo de la tabla dinámica
